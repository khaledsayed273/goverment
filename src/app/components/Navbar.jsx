                        ...
                        {ul.map((item) => (
                            item.path ? (
                                <li onClick={() => {
                                    setOpen(false);
                                    setShowMore(false)
                                }} className={`${pathName === "/about" || pathName === "/contact" || pathName === "/questions" || pathName === "/services" || pathName === "/articles" ? "text-white md:text-[#01579B]" : "text-white"}  hover:text-[#f5c6b6]  md:mx-5 lg:mx-8  my-16 text-center md:my-0 md:text-xl lg:text-2xl  transition-all font-semibold`} key={item.id}>
                                ...
                                <li onClick={() => setShowMore(!showMore)} className='md:mx-5 flex group relative  items-center cursor-pointer lg:mx-8 my-16 text-center md:my-0 md:text-xl lg:text-2xl  transition-all font-semibold ' key={item.id}>
                                    <span className={`${pathName === "/about" || pathName === "/contact" || pathName === "/questions" || pathName === "/services" || pathName === "/articles"   ? "text-white md:text-[#01579B]" : "text-white"}  group-hover:text-[#f5c6b6] `}>{item.name}</span>
